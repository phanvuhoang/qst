  ...
  */
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          var $container = this.options.dialogsInBody ? this.$body : this.$editor;
          var body = [
          '<script>function get_files() {question_image_handler("question"); }</script><B data-dismiss="modal"  data-toggle="tooltip" title="Select a file" style="cursor:pointer" onClick="get_files()">QST des dossiers<BR><P><BR></B>',
