...
(function (global, factory) {
  ...
  $$1.extend($$1.summernote.lang, {
      'en-US': {
          ...
          image: {
              image: 'Image',
              bank: 'Insérer une image de la banque',
              insert: 'Insérer une image',
              resizeFull: 'Taille originale',
              resizeHalf: 'Redimensionner à 50 %',
              resizeQuarter: 'Redimensionner à 25 %',
              resizeNone: 'Pas d\'alignement',
              ...
              maximumFileSizeError: 'Taille de fichier maximale dépassée.',
              url: 'URL de l\'image',
          ...
          link: {
              ...
              url: 'Vers quelle URL ce lien doit-il aller?',
          ...
          help: {
              ...
              'undo': 'Restaurer la dernière action annulée',
              ...
              'insertHorizontalRule': 'Insérer une ligne horizontale de séparation',
  ...
  */
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          var $container = this.options.dialogsInBody ? this.$body : this.$editor;
          var body = [
          '<script>function get_files() {question_image_handler("question"); }</script><B data-dismiss="modal"  data-toggle="tooltip" title="Sélectionner un fichier" style="cursor:pointer" onClick="get_files()">QST des dossiers<BR><P><BR></B>',
            '<div class="form-group note-group-image-url" style="overflow:auto;">',
              '<label class="note-form-label">' + this.lang.image.url + '</label>',
              '<input class="note-image-url form-control note-form-control note-input ',
              ' col-md-8" type="text" />',
              '<BR>&nbsp;&nbsp;Description de l&apos;URL de l&apos;image<P>',
			  ' <textarea placeholder="Pour être conformes aux directives WCAG 2.0, tous les fichiers doivent avoir une description pour les lecteurs d&apos;écran.\n 500 caractères maximum." class="note-image-filedescrip form-control note-form-control note-input ',
			  ' col-md-8" />',
              '</div>',
          ].join('');
...
ImageDialog.prototype.destroy = function () {
              ...
              if (typeof data === 'string') { // image url
                  ...
                  if (_this.options.callbacks.onImageLinkInsert) {
                      _this.context.triggerEvent('image.link.insert', data);
        				...
        				// Added for QST
        				if($whichway == 2) {
							 _this.context.invoke('editor.insertImageQST', data,'Aucune description n&apos;a été ajoutée pour ce fichier.');   // created editor.insertImageQST for this
							}
						else {
  ...
  $$1.summernote = $$1.extend($$1.summernote, {
      ...
      options: {
          ...
          fontNames: [
              'Arial', 'Noir Arial', 'Comic Sans MS', 'Courrier Nouveau',
